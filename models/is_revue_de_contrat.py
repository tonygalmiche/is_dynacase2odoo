...
class is_revue_de_contrat(models.Model):
    ...
    rc_dfn_ro_date_nb                  = fields.Char(string="Nombre de pièces vendues")
    ...
    rc_eiv_etude_cmt                   = fields.Char(string="Commentaire")
    rc_eiv_main_prehension             = fields.Float(string="Main de préhension")
    rc_eiv_main_prehension_cmt         = fields.Char(string="Commentaire")
    rc_eiv_barre_chaude                = fields.Float(string="Barre chaude")
    rc_eiv_barre_chaude_cmt            = fields.Char(string="Commentaire")
    rc_eiv_gab_controle                = fields.Float(string="Gabarit de contrôle")
    rc_eiv_gab_controle_cmt            = fields.Char(string="Commentaire")
    rc_eiv_mach_spec                   = fields.Float(string="Machine spéciale")
    rc_eiv_mach_spec_cmt               = fields.Char(string="Commentaire")
    rc_eiv_plan_valid                  = fields.Float(string="Plan de validation")
    rc_eiv_plan_valid_cmt              = fields.Char(string="Commentaire")
    rc_eiv_mis_point                   = fields.Float(string="Mise au point")
    rc_eiv_mis_point_cmt               = fields.Char(string="Commentaire")
    rc_eiv_pack                        = fields.Float(string="Packaging")
    rc_eiv_pack_cmt                    = fields.Char(string="Commentaire")
    rc_eiv_amort                       = fields.Float(string="Amortissement")
    rc_eiv_amort_cmt                   = fields.Char(string="Commentaire")
