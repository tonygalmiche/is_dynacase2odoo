...
""",
    ...
    "data" : [
        ...
        "views/is_norme_cdc_view.xml",
        "views/is_fnc_view.xml",
        "views/is_reception_view.xml",
        "views/is_factures_view.xml",
        "views/is_reclamation_fournisseur_view.xml",
        "views/is_releve_dimensionnel_view.xml",
        "views/is_ctrl_rcp_view.xml",
        "views/is_processus_view.xml",
        "views/is_planification_audit_view.xml",
        "views/is_res_users_partner_view.xml",
        "views/is_prodstar_view.xml",
        "views/is_oberthur_view.xml",
        "wizard/is_processus_doc_revision_wizard_view.xml",
        "wizard/is_revue_projet_jalon_refus_wizard_view.xml",
        "views/report_is_inv_achat_moule.xml",
        "views/report_is_facture_outillage.xml",
        "views/report_is_demande_essai.xml",
        "views/report_is_demande_essai_eti.xml",
        "views/report_is_fnc.xml",
        "views/report_is_reclamation_fournisseur.xml",
    ...
    "assets": {
        'web.assets_backend': [
            ...
            'is_dynacase2odoo/static/src/cartographie_processus/cartographie_processus.css',
            'is_dynacase2odoo/static/src/cartographie_processus/cartographie_processus.js',
            'is_dynacase2odoo/static/src/cartographie_processus/cartographie_processus.xml',

            # 'is_dynacase2odoo/static/src/js/*',
            # 'is_dynacase2odoo/static/src/dynamic_delete_o2m/*',
            # 'is_dynacase2odoo/static/src/dynamic_one2many_delete/*',
            #'is_dynacase2odoo/static/src/js/list_renderer_patch.js',
            #'is_dynacase2odoo/static/src/js/no_form_in_tree.js',


         ],

        'web.report_assets_common': [
            'is_dynacase2odoo/static/src/scss/report.scss',
